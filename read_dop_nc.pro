...
pro read_dop_nc
  ...
  for i_ocn =0L, 1 do begin
    ...
    if info_safe.check ne 0 then begin
      ...
      ;; Study on water area for the sub-windows
	...
	mean_rvl_azim_terre = mean(rvl_azim_terre[p])
      ...
      ;; looking for a smoother solution in the radial direction correctione
